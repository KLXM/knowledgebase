...
final class FrontendI18n
{
    ...
    private const MANAGED_KEYS = [
        ...
        'knowledgebase_search_recently_updated',
    ...
    private const DEFAULT_TRANSLATIONS = [
        'de' => [
            ...
            'knowledgebase_search_recently_updated' => 'Kürzlich aktualisiert',
        ...
        'en' => [
            ...
            'knowledgebase_search_recently_updated' => 'Recently updated',
